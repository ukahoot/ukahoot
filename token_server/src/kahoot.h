...
static const char* RES_SUCCESS_HEADERS = "HTTP/1.1 200 OK\r\n\
...
Content-Length: 166\r\n\
\r\n";
static const int RES_SUCCESS_HEADERS_LEN = 166;

static const char* RES_FAIL = "HTTP/1.1 403 FORBIDDEN\r\n\
Access-Control-Allow-Origin: *\r\n\
Content-Type: application/json\r\n\
Server: ukahoot_token_server\r\n\
Keep-Alive: timeout=15,max=100\r\n\
Content-Length: 173\r\n\r\n";
static const int RES_FAIL_LEN = 173;
