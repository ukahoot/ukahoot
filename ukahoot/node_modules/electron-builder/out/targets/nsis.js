...
class NsisTarget extends (_electronBuilderCore || _load_electronBuilderCore()).Target {
    ...
    buildInstaller(filesToDelete) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            yield _this4.executeMakensis(defines, commands, true, (yield _this4.computeScript(defines, commands, installerPath)));
    ...
    computeScript(defines, commands, installerPath) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            yield _this5.executeMakensis(defines, commands, false, script);
                ...
                if (isInstaller) {
                    ...
                    for (const item of fileAssociations) {
                        ...
                        for (const ext of extensions) {
                            const customIcon = yield packager.getResource((0, (_metadata || _load_metadata()).getPlatformIconFileName)(item.icon, false), `${extensions[0]}.ico`);
