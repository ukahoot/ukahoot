...
class MacPackager extends (_platformPackager || _load_platformPackager()).PlatformPackager {
    ...
    pack(outDir, arch, targets, postAsyncTasks) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (!hasMas || targets.length > 1) {
                ...
                nonMasPromise = (prepackaged ? (_bluebirdLst2 || _load_bluebirdLst2()).default.resolve() : _this2.doPack(outDir, _path.dirname(appPath), _this2.platform.nodeName, arch, _this2.platformSpecificBuildOptions)).then(function () {
                    return _this2.sign(appPath, null);
                }).then(function () {
            ...
            for (const target of targets) {
                ...
                yield _this2.sign(_path.join(appOutDir, `${_this2.appInfo.productFilename}.app`), masBuildOptions);
            }
    ...
    sign(appPath, masOptions) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (masOptions != null) {
                const pkg = _path.join(_path.dirname(appPath), `${_this3.appInfo.productFilename}-${_this3.appInfo.version}.pkg`);
