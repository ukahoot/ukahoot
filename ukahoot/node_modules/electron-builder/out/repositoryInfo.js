...
let getGitUrlFromGitConfig = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
        let data = null;
        try {
            data = yield (0, (_fsExtraP || _load_fsExtraP()).readFile)(_path.join(".git", "config"), "utf8");
        } catch (e) {
...
let _getInfo = (() => {
    var _ref2 = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (repo) {
        if (repo != null) {
...
function getRepositoryInfo(metadata, devMetadata) {
    return _getInfo((devMetadata == null ? null : devMetadata.repository) || (metadata == null ? null : metadata.repository));
}